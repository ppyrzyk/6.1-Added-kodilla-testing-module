...
public class FlightRetriever {
    ...
    public static FlightRepository retrieve() {
        ...
        Flight flight4 = new Flight("WAW","GDA","KRK","9:55", "10:55", 1121);
        Flight flight5 = new Flight("GDA","RAD","KRK","13:45", "14:55", 1543);
        Flight flight6 = new Flight("LOD","RZE","GDA","14:30", "15:25", 1540);
        Flight flight7 = new Flight("LOD","KRK","KRK", "16:25", "17:30", 1070);
